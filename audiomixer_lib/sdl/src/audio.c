 ...
 * @param newSound       New Sound to add
 *
 */
 ...
 *
 * @return returns a newSound Sound or NULL on failure
 *
 */
...
void playMusic(const char * filename, int volume)
{
    ...
    /* Create newSound music sound with loop */
    ...
    while(global != NULL)
    {
        ...
        /* Set flag to remove any queued up music in favour of newSound music */
